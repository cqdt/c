<%@ Control Language="C#" AutoEventWireup="true" CodeFile="List_LD_KYHDs.ascx.cs" Inherits="Admin_Modules_List_LD_KYHDs" %>
...
<table border="0" width="100%">
  <tr>
     <td align="center">
     Quản lý - Danh sách người lao động được ký hợp đồng  
     </td>     
  </tr>
</table>
<asp:GridView ID="gvListLD"  Width="100%" runat="server" DataKeyNames="PK_LD" 
    ...
    <asp:TemplateField HeaderText="STT" >
        ...
        <asp:TemplateField HeaderText="Họ và tên">
           <ItemTemplate>
              <asp:TextBox ID="txtName" BorderWidth="0" Text='<%# Eval("C_HO_TEN")%>' Width="140px" runat="server"></asp:TextBox>
        ...
        <%--<asp:TemplateField HeaderText="Trạng th&#225;i">
           <ItemTemplate>
              <CMS:Status ID="Status1" ActiveText="" InActiveText="" Value='<%# Eval("C_STATUS") %>' runat="server"></CMS:Status>
           </ItemTemplate>
           <ItemStyle Width="70px" />
        </asp:TemplateField>--%>
...
<asp:Button ID="btnCancel" runat="server" Text="Huỷ bỏ" 
 ...
 <asp:SqlDataSource ID="ListLDsDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>"
   SelectCommand="SELECT * FROM T_LD_KYHD">   
</asp:SqlDataSource>