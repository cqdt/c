<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Thong-ke-xuat-canh.ascx.cs"
    Inherits="Admin_Modules_Thong_ke_xuat_canh" %>
...
<table border="0" width="100%">
    <tr>
        <td align="center">
            Thống kê - Danh sách người lao động xuất cảnh đi làm việc tại Hàn Quốc
        </td>
    </tr>
</table>
<br />
...
<asp:GridView ID="gvListLD" Width="100%" runat="server" DataKeyNames="PK_XC" AutoGenerateColumns="False"
    ...
    <Columns>
        ...
        <asp:TemplateField HeaderText="Trạng th&#225;i">
            <ItemTemplate>
                <CMS:Status ID="Status1" ActiveText="Hiển thị" InActiveText="Chưa hiển thị" Value='<%# Eval("C_STATUS") %>'
                    runat="server"></CMS:Status>
            </ItemTemplate>
