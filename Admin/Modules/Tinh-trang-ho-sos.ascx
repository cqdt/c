<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Tinh-trang-ho-sos.ascx.cs" Inherits="Admin_Modules_Tinh_trang_ho_sos" %>
...
<table border="0" width="100%">
  <tr>
     <td align="center" bgcolor="#e4f2fe" colspan="3">
      <b>Quản lý - Danh sách tình trạng hồ sơ</b>
     </td>     
  </tr> 
</table>
...
<asp:GridView ID="gvListRegister"  Width="100%" runat="server" DataKeyNames="PK_HOSO" 
    ...
    <asp:TemplateField HeaderText="STT" >
        ...
        <asp:TemplateField HeaderText="#">
           <ItemTemplate>
             <input name="chkFAQs" class="checkbox" type="checkbox" value="<%# Eval("PK_HOSO") %>" />
           </ItemTemplate>
...
<asp:SqlDataSource ID="ListRegisterDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>"
   SelectCommand="SELECT * from T_HOSO">   
   <SelectParameters>    
