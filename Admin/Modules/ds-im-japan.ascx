<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ds-im-japan.ascx.cs" Inherits="Admin_Modules_ds_im_japan" %>
...
<table border="0" width="100%">
  <tr>
     <td align="center" bgcolor="#e4f2fe" colspan="3" height="30">
      <b>Ứng viên đăng ký tham gia dự tuyển chương trình thực tập kỹ thuật tại Nhật Bản</b>
     </td>     
  </tr> 
</table>
...
<asp:GridView ID="gvList" Width="100%" runat="server" DataKeyNames="PK_IM"
...
<asp:SqlDataSource ID="ListRegisterDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>"
    SelectCommand="SELECT * from T_IM where C_NGAYDANGKY >  '2020-01-01 00:00:00.000' order by PK_IM desc"></asp:SqlDataSource>
