<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ket-noi-theo-muc-luong.ascx.cs" Inherits="Admin_Modules_ket_noi_theo_muc_luong" %>
...
<table border="0" width="100%" cellpadding="0" cellspacing="0">
    ...
    <td id="Td1" width="280" runat="server" bgcolor="#f9cd58">
        ...
        <td align="left" bgcolor="#f9cd58"  height="30" >
            <b>Kết nối vị trí tuyển dụng và người lao động với mức lương : <asp:Label ID="Label1" runat="server" Text="" ForeColor="red"></asp:Label></b>
        </td>
    </tr>
</table>
