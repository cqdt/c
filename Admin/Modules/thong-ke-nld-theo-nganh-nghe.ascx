<%@ Control Language="C#" AutoEventWireup="true" CodeFile="thong-ke-nld-theo-nganh-nghe.ascx.cs" Inherits="Admin_Modules_thong_ke_nld_theo_nganh_nghe" %>
...
<table border="0" width="100%" cellpadding="0" cellspacing="0">
    ...
    <td id="Td1" width="280" runat="server" bgcolor="#f9cd58">
        ...
        <td align="left" bgcolor="#f9cd58"  height="30" >
            <b>Thống kê danh sách người lao động theo ngành nghề <asp:Label ID="Label1" runat="server" Text="" ForeColor="red"></asp:Label></b>
        </td>
    </tr>
</table>
