<%@ Control Language="C#" AutoEventWireup="true" CodeFile="thong-ke-nld-theo-ngoai-ngu.ascx.cs" Inherits="Admin_Modules_thong_ke_nld_theo_ngoai_ngu" %>
...
<table border="0" width="100%" cellpadding="0" cellspacing="0">
    ...
    <td id="Td1" width="280" runat="server" bgcolor="#f9cd58">
            ...
            <asp:DropDownList ID="ddlCongty" runat="server" Width="150"  height="25">          
                ...
                <asp:ListItem value="Tiếng Hàn">Tiếng Hàn</asp:ListItem>
                <asp:ListItem value="Tiếng Nhật">Tiếng Nhật</asp:ListItem>
             </asp:DropDownList>
        </td>
        <td bgcolor="#f9cd58">
