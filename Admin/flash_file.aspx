...
<body>
       <script type="text/javascript">
	        ...
	        {
		        window.opener.refreshPage1(Image);
		        window.close();
	        }
    ...
    <div>
       ...
       <center>
        ...
        <center>
         ...
         <radU:RadUpload ID="raduText" runat="server" AllowedFileExtensions=".mp4" Skin="Office2007" TargetFolder="~/uploads/News/" Width="380px" />
        </center>
        <center>
