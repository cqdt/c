<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Top1NewsArtiles.ascx.cs" Inherits="Modules_BDS_Top1NewsArtiles" %>
...
<table border="0" cellpadding="1" cellspacing="1" width="100%">
    ...
    <tr>
        <td background="images/Index_05_01.jpg1" style="background-repeat:repeat-y">
