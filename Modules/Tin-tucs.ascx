<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Tin-tucs.ascx.cs" Inherits="Modules_Tin_tucs" %>
...
<div class="img_24">
    <uc1:Articles ID="Articles1" IsParent="true" OnPageIndexChange="Articles1_PageIndexChange" Rows="20" runat="server" /> 
