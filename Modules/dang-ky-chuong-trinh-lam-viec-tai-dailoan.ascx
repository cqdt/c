...
<div class="title_cate">
    ...
    <a class="a_title_cate">Đăng ký dự tuyển chương trình làm việc tại Đài Loan <asp:Label runat="server" ID="lblmes"></asp:Label></a>
</div>    
...
<div class="img_24">
    <ul class="dangkytienghan">
        ...
        <li><span class="hokhau">Số điện thoại di động:</span><asp:TextBox ID="txtdienthoai1" CssClass="txthoten" Width="330" runat="server"  onkeydown="return jsDecimals(event);" MaxLength="12"></asp:TextBox></li>
