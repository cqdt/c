<%@ Control Language="C#" AutoEventWireup="true" CodeFile="dang-ky-du-tuyen-chuong-trinh-ho-ly-nhatban.ascx.cs" Inherits="Modules_dang_ky_du_tuyen_chuong_trinh_ho_ly_nhatban" %>
...
<div class="title_cate">
    ...
    <a class="a_title_cate">Đăng ký dự tuyển chương trình Hộ lý tại Nhật Bản</a>
</div>    
...
<div class="img_24">
    <ul class="dangkytienghan">
        ...
        <li><span class="hokhau">Giới tính</span>
             <select runat="server" id="cbogioitinh" class="honnhan" style="width:330px;">
        ...
        <li><span class="hokhau">Số điện thoại liên hệ2:</span><asp:TextBox ID="txtdienthoailienhe2" CssClass="txthoten" Width="330" runat="server"  onkeydown="return jsDecimals(event);" MaxLength="11"></asp:TextBox></li>
        ...
        <li style="display:none"><b><i style="width:100%;float:left;margin:15px 0 5px 0;text-align:center">Thông tin về trình độ học vấn, chuyên môn của người đăng ký</i></b></li>
         ...
         <li style="display:none"><span class="hokhau">Tình trạng học tập hiện nay</span>
             <select runat="server" id="cbotinhtranghoc" class="">
        ...
        <li><span class="hokhau">Hệ đào tạo</span>
             <select runat="server" id="cbodaotao" class="">
        ...
        <li>
            <asp:Button ID="btngui" runat="server" Text="Đăng ký" CssClass="btngui im" OnClick="btngui_Click"/>
        </li>
