...
<div class="img_24">
    <ul class="nld_dangkytdld">
        ...
        <li><span class="lblhodem">1- Họ và đệm <b>(*)</b></span>
            <asp:TextBox CssClass="txthodem" ID="txthodem" Width="150px" Height="30" runat="server"></asp:TextBox>
        ...
        <li><span class="lblhodem">5- Hộ chiếu <b>(*)</b></span>
            <asp:TextBox CssClass="txthodem" ID="txtCMND" Width="414px" Height="30" runat="server"></asp:TextBox>
        </li>
        ...
        <span class="lblCMND_NLD"><br />6- Địa chỉ cư trú <b>(*)</b></span>
            ...
            <table cellpadding="0" cellspacing="0">
                <tr>
                 ...
                 <tr>
                    <td> <asp:TextBox CssClass="txthodem" ID="txtDiachi" Width="150px" Height="30" runat="server"></asp:TextBox></td>
                    <td><asp:TextBox CssClass="txthodem" ID="txtHuyen" Width="120px" runat="server" Height="30"></asp:TextBox></td>
                    <td>
                    
                    <select class="danhmucnghe" style="width: 137px; height: 36px;" id="cboTinh" runat="server">
                <option value="">--- --- ---</option>
        ...
        <li><span class="lblhodem">8- Ngày xuất cảnh <b>(*)</b></span>
        ...
        <li><span class="lblhodem">12- Ngoại ngữ <b>(*)</b></span>
            <select class="danhmucnghe" style="width: 156px; height: 36px;" id="cboNgoaingu"
                runat="server">
                <option value="">--- --- ---</option>
            ...
            <span class="lblsoid">13- Chứng chỉ<br />
                /trình độ</span>
            <select class="danhmucnghe" style="width: 142px; height: 36px;" id="cboChungchi"
                runat="server">
                <option value="">--- --- ---</option>
        ...
        <li><span class="lblhodem">15- Bằng cấp <b>(*)</b></span>
            <select class="danhmucnghe" style="width: 157px; height: 36px;" id="cboBangcap1"
                runat="server">
                <option value="">--- --- ---</option>
            ...
            <asp:TextBox CssClass="txthodem" ID="txtBangcapkhac1" Width="222px" Height="30" runat="server"></asp:TextBox>
        </li>
        <li>
            <table width="100%">
                <tr>
                    <td width="170">
                        <span class="nld_nghelamviec">16- Ngành nghề làm việc <b>(*)</b></span>
                    </td>
                    <td>
                        <span class="lbltuden">Từ</span>
                    </td>
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox CssClass="txthodem" ID="txtCongvieccuthe1" Width="150px" Height="30"
        ...
        <li>
            <table width="100%">
                <tr>
                    <td width="170">
                        <span class="nld_nghelamviec">17- Ngành nghề làm việc 2</span>
                    </td>
                    <td>
                        <span class="lbltuden">Từ</span>
                    </td>
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox CssClass="txthodem" ID="txtCongvieccuthe2" Width="150" Height="30" runat="server"></asp:TextBox>
                    </td>
                </tr>
            </table>
        </li>
        ...
        <li>
            <table width="100%">
                <tr>
                    <td width="170">
                        <span class="nld_nghelamviec">18- Ngành nghề làm việc 3</span>
                    </td>
                    <td>
                        <span class="lbltuden">Từ</span>
                    </td>
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox CssClass="txthodem" ID="txtCongvieccuthe3" Width="150" Height="30" runat="server"></asp:TextBox>
                    </td>
                </tr>
            </table>
        </li>
...
<script type="text/javascript">
    var verifyCallback = function (response) {
        ...
        $("#<%=btndangky.ClientID %>").removeAttr("disabled");

      };
    var onloadCallback = function () {
          $("#<%=btndangky.ClientID %>").attr("disabled", 'disabled');
