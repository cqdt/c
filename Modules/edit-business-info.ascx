     ...
     <li> <center>
       ...
       <li>
            <span class="tencongtydk">1- TRA CỨU THÔNG TIN/ 내용검색</span>
             <asp:TextBox ID="txtMaTD" Width="266" Height="30" runat="server" onfocus="if(this.value=='NHẬP MÃ TUYỂN DỤNG/채용번호 입력') this.value='';"
        ...
        <li>
            ...
            <asp:TextBox ID="txtlaydienthoai" Width="130" Height="30" runat="server" onfocus="if(this.value=='Điện thoại/전화번호') this.value='';"
                    onblur="if(this.value=='') this.value='Điện thoại/전화번호';" value="Điện thoại/전화번호"></asp:TextBox>
            <asp:TextBox ID="txtlayemail" Width="130" Height="30" runat="server" onfocus="if(this.value=='Email/이메일') this.value='';"
        ...
        <li>
            ...
            <asp:TextBox ID="txtTencongty" Width="409" Height="30" runat="server"></asp:TextBox>
        </li>
        <li>
            <span class="tencongtydk">2- Ngành nghề <br />&nbsp;&nbsp;&nbsp;업종 <b>(*)</b></span>

             <asp:DropDownList ID="cbonganhnghe" runat="server" Height="36" Width="158" CssClass="txthodem">
            </asp:DropDownList>

            <span class="chucdanh">Mô tả<br /> 서술</span>
            <asp:TextBox ID="txtmota" runat="server" Width="172" Height="30"></asp:TextBox>
        </li>
        <li><span class="tencongtydk">3- Địa chỉ công ty<br />&nbsp;&nbsp;&nbsp; 회사 주소 <b>(*)</b></span>
            <asp:TextBox ID="txtdiachicongty" Width="197" runat="server" Height="30" CssClass="txtdiachicongty"></asp:TextBox>
            
            <asp:TextBox ID="txthuyen" runat="server" Width="118" Height="30" CssClass="txtdiachicongty"></asp:TextBox>
            <select class="danhmucnghe" style="width:88px;height:36px;" id="cboTinh" runat="server">
            <option value="">---</option>
        ...
        <li>
            ...
            <asp:TextBox ID="txtwebsite" Width="409" Height="30" runat="server"></asp:TextBox>
        </li>
        <li>
            ...
            <asp:TextBox ID="txtnguoilienhe" Width="360" Height="30" runat="server"></asp:TextBox>
        </li>
        <li>
        <span class="tencongtydk">6- Chức danh <br />&nbsp;&nbsp;&nbsp;직명</span>
            <asp:TextBox ID="txtchucdanh" Width="409" Height="30" runat="server"></asp:TextBox>
        </li>
        <li>
        <span class="tencongtydk">7- Điện thoại<br />&nbsp;&nbsp;&nbsp; 전화번호 <b>(*)</b></span>
            <asp:TextBox ID="txtdienthoailienhe" Width="409" Height="30" runat="server" onkeypress="return isNumberKey(event)"></asp:TextBox>
        </li>
        <li>
            <span class="tencongtydk">8- Email <br />&nbsp;&nbsp;&nbsp;이메일 <b>(*)</b></span>
            <asp:TextBox ID="txtemail" Width="409" Height="30" runat="server"></asp:TextBox>
        </li>

         <li>
            <span class="tencongtydk">9- Mã tuyển dụng <br />&nbsp;&nbsp;&nbsp;채용번호</span>
            <asp:TextBox ReadOnly="true" ID="txtmaTuyendung" Width="409" Height="30" runat="server" CssClass="txtlaylaimatuyendung"></asp:TextBox>
        </li>

        <li>&nbsp;</li>

        <li>
            <asp:Button ID="btnFinish" CssClass="btnedit" runat="server" Text=" 완료 " 
