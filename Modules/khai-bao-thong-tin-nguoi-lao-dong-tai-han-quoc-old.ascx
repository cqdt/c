<%@ Control Language="C#" AutoEventWireup="true" CodeFile="khai-bao-thong-tin-nguoi-lao-dong-tai-han-quoc-old.ascx.cs"
    Inherits="Modules_khai_bao_thong_tin_nguoi_lao_dong_tai_han_quoc_old" %>
