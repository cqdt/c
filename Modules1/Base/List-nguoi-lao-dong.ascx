<%@ Control Language="C#" AutoEventWireup="true" CodeFile="List-nguoi-lao-dong.ascx.cs" Inherits="Modules_Base_List_nguoi_lao_dong" %>
								...
								<tr>								
								 ...
								 <tr>								 
								  ...
								  <tr>								  
								   ...
								   <tr>
								    <td class="nentd" colspan="2"><uc3:Article ID="Huongdan2" ArticleID="387" AutoLang="true" runat="server" /> </td>
								 </tr>
							</table>	</center>						
					 </ItemTemplate>
				</asp:TemplateField>
