<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Tinh-trang-ho-so.ascx.cs" Inherits="Modules_Tinh_trang_ho_so" %>
<%@ Register Src="Base/Danh-sach-tinh-trang-ho-so.ascx" TagName="List" TagPrefix="uc2" %>
<%@ Register Src="Controls/search-hoso.ascx" TagName="Searchtn" TagPrefix="uc1" %>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td align="left" height="42" class="title_box" background="Images/Index2_21.png"> 
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            <td>Tìm kiếm thông tin hồ sơ</td>
                        </tr>
                         <tr>
                            <td height="10">&nbsp;</td>
                        </tr>
