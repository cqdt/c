...
<div class="img_240">
    ...
    <li>
      <span class="dangkytimviec" style="TEXT-ALIGN: center;font-size: 18px;">TÌM CÔNG TY TUYỂN DỤNG </span>
        ...
        <li style="text-align:center">
            <asp:Button ID="btntimkiem" CssClass="btndangky" runat="server" Text=" TÌM KIẾM "
                OnClick="btntimkiem_Click" style="background-color: #b58d0f;color: #ffffff;"/>
        </li>
