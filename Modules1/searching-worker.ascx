     ...
     <li>
         <span class="tencongty">Nghề/직업/업종</span>        
          ...
          <asp:DropDownList ID="cboNganhngheduocdaotao" runat="server" 
                CssClass="danhmucnghe" style="width: 152px; height: 36px;" 
                >
            </asp:DropDownList>
           ...
           <select class="danhmucnghe" style="width: 143px; height: 36px;" id="cboNamlamviec" runat="server">
                <option value="">---</option>
        ...
        <li>
            <span class="tencongty">3- Yêu cầu về kỹ năng tiếng Hàn/ 한국어능력 요구</span>
              ...
              <select class="danhmucnghe" style="width: 152px; height: 36px;" id="cboChungchi" runat="server">
                <option value="">--- --- ---</option>
        ...
        <li>
         <span class="tencongty">4- Mức lương<br />&nbsp;&nbsp;&nbsp; 임금</span>
          ...
          <select id="choMucluongmongmuon" runat="server" class="danhmucnghe" style="width: 152px;height:36px;">
        ...
        <li>
           ...
           <select class="danhmucnghe" style="width: 152px; height: 36px;" id="cboTinh" runat="server">
