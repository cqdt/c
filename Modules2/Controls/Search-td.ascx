<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Search-td.ascx.cs" Inherits="Modules_Controls_Search_td" %>
    ...
    <tr>
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%">          
            <tr>
                <td width="13">&nbsp;</td>
                <td>                
                <asp:TextBox ID="txtdiadiem" Width="100" runat="server" CssClass="texbox4"                
                Height="15px" BorderStyle="None" ></asp:TextBox>
                </td>
            </tr>
        </table>
