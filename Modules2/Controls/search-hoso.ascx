<%@ Control Language="C#" AutoEventWireup="true" CodeFile="search-hoso.ascx.cs" Inherits="Modules_Controls_search_hoso" %>
<asp:Panel ID="pnSearchBDS" DefaultButton="btnTimkiemxc" runat="server">
    ...
    <tr>
        ...
        <td align="left" valign="top">
         <asp:ValidationSummary ID="vSearch1" ValidationGroup="vSearch1" ShowSummary="false"
                    ...
                    ShowMessageBox="true" />
             <asp:ImageButton ID="btnTimkiemxc" ValidationGroup="vSearch1" ImageUrl="~/Images/search.jpg" CssClass="image5"  BorderWidth="0" OnClick="btnTimkiemxc_Click" runat="server" ToolTip="Search" />
        </td>
    </tr>
