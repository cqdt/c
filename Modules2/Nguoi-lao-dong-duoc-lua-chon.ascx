<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Nguoi-lao-dong-duoc-lua-chon.ascx.cs" Inherits="Modules_Nguoi_lao_dong_duoc_lua_chon" %>
<%@ Register Src="Base/List-nguoi-lao-dong.ascx" TagName="List" TagPrefix="uc2" %>
<%@ Register Src="Controls/Search-ld.ascx" TagName="Searchld" TagPrefix="uc1" %>
