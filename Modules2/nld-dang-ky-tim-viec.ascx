...
<div class="img_24">
    <ul class="dangkytdld">
        ...
        <li><span class="thongtindn">B. ĐĂNG KÝ TÌM VIỆC</span></li>
         ...
         <li><span class="lbldangkytuyendung">10- Lựa chọn hình thức tuyển dụng <b>(*)</b></span>
             <asp:DropDownList ID="ddlHinhthuc" runat="server" AutoPostBack="true" 
                 onselectedindexchanged="ddlHinhthuc_SelectedIndexChanged" Width="600" Height="36">
         ...
         <li><span class="lbldangkytuyendung">11- Đăng ký phiên giao dịch việc làm <b>(*)</b></span>
             <asp:DropDownList ID="ddlListPhienGDVL" runat="server"  Width="600" Height="36"
                 AutoPostBack="True" 
        ...
        <asp:DropDownList ID="ddlDoanhnghiep" runat="server" OnSelectedIndexChanged="ddlDoanhnghiep_SelectedIndexChanged"  Width="600" Height="36"
                AutoPostBack="true">
            </asp:DropDownList>

              <asp:DropDownList ID="ddlDoanhnghiepImport" runat="server"   Width="600" Height="36"
                AutoPostBack="true" 
        ...
        <li><span class="lbldangkytuyendung">13- Đăng ký vị trí tuyển dụng <b>(*)</b></span>
            <asp:DropDownList ID="ddlVitrituyen" runat="server"  Width="600" Height="36">
            </asp:DropDownList>

        </li>
        <li>
            <asp:Button ID="btndangky" CssClass="btndangky" runat="server" style="background-color: #025dab;color:#fff" Text=" ĐĂNG KÝ " OnClick="btndangky_Click" />
        </li>
