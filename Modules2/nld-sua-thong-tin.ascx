...
<div class="img_240">
    <ul class="dangkytdld">
      ...
      <li>
        ...
        <li style="text-align: center;">
             <asp:Button ID="btndangnhap" CssClass="btngo" runat="server" Text=" TRA CỨU " Height="36" Width="114"
                onclick="btndangnhap_Click" style="background-color: #b58d0f;color: #ffffff; float:none"/>
        </li>
        <li>
        ...
        <li style="text-align: center;">
             <asp:Button ID="btnTimkiem" CssClass="btngo" runat="server" Text=" TÌM KIẾM " 
                onclick="btnTimkiem_Click" Height="36" Width="114" style="background-color: #b58d0f;color: #ffffff; float:none"/>
        </li>
 ...
 <li><span class="thongtindn">I. THÔNG TIN CHUNG</span> </li>
        <li><span class="lblhodem">1- Họ và đệm (*)</span>
          <span>  <asp:TextBox CssClass="txthodem" ID="txthodem" Width="250px" height= "30px" runat="server"></asp:TextBox></span>
          
            <span class="lblten_NLD">2- Tên (*)</span>
            <asp:TextBox CssClass="txthodem" ID="txtten" Width="250px" Height="30" runat="server"></asp:TextBox>
        </li>
        ...
        <li><span class="lblCMND_NLD">5- Số CMND<br />
            &nbsp;&nbsp;&nbsp;/Hộ chiếu <b>(*)</b></span>
            <asp:TextBox CssClass="txthodem" ID="txtCMND" Width="645px" Height="30" onkeypress="return isNumberKey(event)" runat="server"></asp:TextBox>
        </li>
        <li><span class="lblCMND_NLD">6- Địa chỉ<br />
            &nbsp;&nbsp;&nbsp; cư trú <b>(*)</b></span>

             <asp:TextBox CssClass="txthodem" ID="txtDiachi" Width="240px" Height="30" runat="server"></asp:TextBox>


            <span class="lblhuyen">Huyện</span>
            <asp:TextBox CssClass="txthodem" ID="txtHuyen" Width="200px" runat="server" Height="30"></asp:TextBox>
            <span class="lblhuyen">Tỉnh</span>
            <select class="danhmucnghe" style="width: 83px; height: 36px; float:none" id="cboTinh" runat="server">
                <option value="">--- --- ---</option>
        ...
        <li><span class="lblCMND_NLD">7- Tên chương trình<br />
           ...
           <select class="danhmucnghe" style="width: 156px; height: 36px;" id="cboChuongtrinhthamgia"
              ...
              <span class="lblsoid">Số ID tại nước
                <br />
                ngoài<b> (*)</b></span>
             <asp:TextBox CssClass="txthodem" ID="txtIDnuocngoai" Width="365px" Height="30" runat="server"></asp:TextBox>
        </li>
        ...
        <li><span class="lblCMND_NLD">10- Số điện thoại<br />
            &nbsp;&nbsp;&nbsp;liên hệ <b>(*)</b></span>
            <asp:TextBox CssClass="txthodem" ID="txtDienthoai" Width="250px" Height="30" runat="server" onkeypress="return isNumberKey(event)"></asp:TextBox>
             </li>
        <li>
            
            <span class="lblCMND_NLD">11- Địa chỉ<br />
                &nbsp;&nbsp;&nbsp; email <b>(*)</b></span>
            <asp:TextBox CssClass="txthodem" ID="txtEmail" Width="250px" runat="server" Height="30"></asp:TextBox>
        </li>
        <li></li>
         <li>
            
             <asp:Button ID="btnFinish" CssClass="btnhoantat" runat="server" Text=" HOÀN TẤT " style="background-color: #b58d0f;color: #ffffff; float:none" OnClientClick="return CheckSubmit()" 
                 onclick="btnFinish_Click" />
                 
             <asp:Button ID="btnEditinfo" CssClass="btndangky" runat="server" Text=" SỬA THÔNG TIN ĐĂNG KÝ " style="background-color: #025dab;color: #ffffff;" OnClientClick="EditInfo(); return false;"
                 />
        </li>
